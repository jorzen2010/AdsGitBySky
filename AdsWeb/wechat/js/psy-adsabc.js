...
var SkyGanjue = ["感觉能力", "交往能力", "运动能力", "语言能力", "自理能力", ];
var SkyAdsABCData = [
    {
        Number: '1',
        Title: '喜欢长时间的自身旋转',
...
function adsabcInit() {
    ...
    for (var i = 0; i < SkyAdsABCData.length; i++) {
        ...
        var dd = '<label class="rdobox unchecked"  data-num=' + SkyAdsABCData[i].Number + ' onclick="return do_next(' + i + ')"><span class="radiobox-content">是</span> </label>';
        var ee = '<input name="' + SkyAdsABCData[i].Number + '" data-Dimension="' + SkyAdsABCData[i].Dimension + '" class="rdolist" type="radio" value="0">';
        var ff = '<label class="rdobox unchecked"  onclick="do_next(' + i + ')"><span class="radiobox-content">否</span> </label>';
